...
public class AgendamentoService {
    ...
    public List<Agendamento> pegarAgendamentosPorDatas (LocalDateTime dataInicio, LocalDateTime dataFim) {
        var agendamentos = agendamentoRepository.buscarPorIntervaloDeDatas(dataInicio, dataFim);
        return agendamentos;
    }
}
