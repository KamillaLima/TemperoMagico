...
public class MesaController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Mesa> ExcluirMesaPeloId (@PathVariable Long id){
        var mesaExcluida = mesaService.RemoverMesa(id);
        if (mesaExcluida == null) return ResponseEntity.badRequest().build();
